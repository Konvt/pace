        ...
        if ( !this->lead_.empty() ) {
          ...
          if ( current_lead.width() <= this->bar_width_ ) {
            ...
            if ( current_lead.width() <= len_vacancy ) {
              ...
              pipeline << this->clear_then_dye( this->lead_col_, params.style_off_ ) << current_lead
                       << this->clear_then_dye( this->filler_col_, params.style_off_ );
              ...
              pipeline << this->clear_then_dye( this->lead_col_, params.style_off_ ) << right_part
                       << this->clear_then_dye( this->filler_col_, params.style_off_ );
