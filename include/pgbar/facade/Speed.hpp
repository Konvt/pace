...
namespace pgbar {
  namespace option {
     ...
     */
    struct Magnitude : PGBAR__DERIVING_OPTION1( Magnitude, std::uint16_t, _magnitude );
  ...
  namespace facade {
    ...
    class Speed : public Base {
      friend PGBAR__FORCEINLINE PGBAR__CXX20_CNSTXPR void unpack( Speed& self,
...
#undef PGBAR__METHOD
      ...
      PGBAR__CXX20_CNSTXPR void swap( Speed& other ) & noexcept
      {
