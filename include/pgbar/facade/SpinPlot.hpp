...
namespace pgbar {
  ...
  PGBAR__INHERIT_REGISTER( facade::SpinPlot, details::aspects::Frame );

  PGBAR__ENTAIL_REGISTER( facade::SpinPlot, details::behaviors::Indeterminate, details::behaviors::Fancy );
} // namespace pgbar
