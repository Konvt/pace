  ...
  namespace details {
    namespace behaviors {
      ...
      protected:
        ...
        PGBAR__CXX14_CNSTXPR Fancy& operator=( Fancy&& rhs ) & noexcept
        {
          Base::operator=( std::move( rhs ) );
          return *this;
        }
        PGBAR__CXX23_CNSTXPR ~Fancy() = default;
    ...
    PGBAR__INHERIT_REGISTER( behaviors::Fancy, behaviors::Renderable, behaviors::Motional );
  } // namespace details
} // namespace pgbar
