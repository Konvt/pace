#ifndef PGBAR_ENTAILMENT
#define PGBAR_ENTAILMENT
...
#define PGBAR__ENTAIL_REGISTER( Facade, ... )                      \
  template<>                                                       \
  struct pgbar::details::aspects::EntailOf<Facade> {               \
    using type = pgbar::details::traits::C3Container<__VA_ARGS__>; \
  }
