  ...
  namespace details {
    namespace aspects {
      ...
      class Frame : public Base {
        friend PGBAR__FORCEINLINE void unpack( Frame& self, option::LeadColor&& val ) noexcept
        {
          self.lead_col_ = val.value();
        }
        friend PGBAR__FORCEINLINE PGBAR__CXX20_CNSTXPR void unpack( Frame& self, option::Lead&& val ) noexcept
        {
      ...
      protected:
        ...
        PGBAR__CXX20_CNSTXPR Frame( traits::TypeSet<Options...> tag ) : Base( tag )
        {
        ...
        PGBAR__SPECIAL_MEMBERS_CX( Frame, PGBAR__CXX20_CNSTXPR );
...
#define PGBAR__METHOD( OptionName, ParamName, ReturnType, Operation ) \
  ...
  return static_cast<ReturnType>( *this )
        ...
        {
          PGBAR__METHOD( Lead, _lead, Derived&, std::move );
        }
        Derived&& lead( types::String _lead ) &&
        {
          PGBAR__METHOD( Lead, _lead, Derived&&, std::move );
        ...
        {
          PGBAR__METHOD( Lead, _lead, Derived&, );
        }
        Derived&& lead( types::LitU8 _lead ) &&
        {
          PGBAR__METHOD( Lead, _lead, Derived&&, );
...
#undef PGBAR__METHOD
        ...
        PGBAR__CXX20_CNSTXPR void swap( Frame& other ) noexcept
        {
          using std::swap;
